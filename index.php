...
<body onload= "ajax(); ">
<h2 class="text-primary">Simple Chat Application</h2>
<div class="container" style="" >
    ...
    <div id="chat_box" style=" ">
        ...
        <form method = "post" action="index.php" class="form-horizontal" style="margin-top:150px; background-color:#659DBD">
